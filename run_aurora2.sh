...
export input_file=/flare/PorousMatCarbon/jacksonjhayes/source/JuliaChem.jl/example_inputs/gly/df_gpu/gly10.json
mpiexec -n 1 --depth=52 --cpu-bind=list:0-51 /soft/tools/mpi_wrapper_utils/gpu_tile_compact.sh julia --threads=52 ./example_scripts/full-rhf.jl $input_file &> ./gly10.log